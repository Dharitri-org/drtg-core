//go:generate protoc -I=. -I=$GOPATH/src/github.com/Dharitri-org/drtg-core/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/Dharitri-org/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
